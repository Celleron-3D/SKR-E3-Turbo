...
#define STRING_CONFIG_H_AUTHOR "(Celleron, Ender-3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR E3 Turbo"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 14), (Y_MAX_POS - 16), 20 }
